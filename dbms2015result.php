...
<div class="container" style="margin-top:90px;" align="center">
            <div class="container" align="center">
		
		<div class="well" style="text-align:center"><b>NPTEL Results</b></div>
                <h4 class="panel-title">DATABASE MANAGEMENT SYSTEM 2015 RESULT</h4><br><br>
...
$sql="SELECT * from dbml2015result order by percentage desc";
